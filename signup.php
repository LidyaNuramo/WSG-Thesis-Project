                        ...
                        <div class="row pb-4">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control phone-inputmask" id="phone-mask" placeholder="Enter Phone Number" style="-webkit-appearance= none; -moz-appearance= textfield;" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Phone Number" aria-label="Phone Number" aria-describedby="basic-addon1" style="-webkit-appearance= none; -moz-appearance= textfield;" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
