            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit customer account</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item"><a href="caccounts.php">Customers</a></li>
                    ...
                    <?php
                        if(!empty($_GET['action']))
                        {
                            ...
                            case 'updateemail':
                                ...
                                $database=new Database();
                                $where1['Email']= '="'.$email.'"';
                                $results=$database->getRows("client","*",$where1);
                                $num=1;
                                ...
                                if ($num==1){
                                    ...
                                    $database->updateRows("client",$data,$whereuser);
                                    break;
                                }
                                else{
                                    echo '
